...
struct URLContentMetaData {
    ...
    /// The exact CoreKiwix registration generation this metadata came from.
    /// Streaming providers reject it after a rebind instead of combining old
    /// lengths/offsets with a replacement archive.
    let zimFileID: UUID?
