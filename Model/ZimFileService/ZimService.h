...
- (void)closeArchive:(NSUUID *_Nonnull)zimFileID NS_REFINED_FOR_SWIFT;
- (Boolean)isArchiveOpen:(NSUUID *_Nonnull)zimFileID NS_REFINED_FOR_SWIFT;
...
+ (Boolean)isSemanticallyReadableWithFileURL:(nonnull NSURL *)url NS_REFINED_FOR_SWIFT;

# pragma mark - URL Handling

- (NSURL *_Nullable)getFileURL:(NSUUID *_Nonnull)zimFileID NS_REFINED_FOR_SWIFT;
- (void)setLogicalFileURL:(NSURL *_Nonnull)url
            forIdentifier:(NSUUID *_Nonnull)zimFileID NS_REFINED_FOR_SWIFT;
- (NSUUID *_Nullable)registeredIdentifierForFileURL:(NSURL *_Nonnull)url NS_REFINED_FOR_SWIFT;
